...
class Atri:
	...
	@property
	def h1Header(self):
		self._getter_access_tracker["h1Header"] = {}
		return self._h1Header
	@h1Header.setter
	def h1Header(self, new_state):
		self._setter_access_tracker["h1Header"] = {}
		global default_state
		self._h1Header = TextBox(new_state, default_state["h1Header"])
